...
export default function ProcessingPage() {
  ...
  useEffect(() => {
    ...
    const processPayment = async () => {
      // Set a minimum satisfying spin delay of 2 seconds for high-fidelity mechanical rotation
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", background: "#0b0f19", overflow: "hidden" }}>
      {/* Background Floating Orbs in Dark Slate Palette */}
      <BackgroundOrbs opacity1={0.45} opacity2={0.35} opacity3={0.35} />

      {/* Render the full-screen Gearbox loader inside this standalone route */}
      <GearLoader 
        isOpen={true} 
